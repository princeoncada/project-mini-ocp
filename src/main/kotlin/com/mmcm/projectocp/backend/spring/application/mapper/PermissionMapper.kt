...
class PermissionMapper: EntityMapper<Permission, PermissionDTOs.GetResult, PermissionDTOs.PostRequest, PermissionDTOs.PutRequest> {
    override fun toGetResult(entity: Permission): PermissionDTOs.GetResult {
    ...
    override fun createEntity(id: String, entityRequest: PermissionDTOs.PostRequest): Permission {
        return Permission(
            id = id,
    ...
    override fun updateEntity(entity: Permission, entityRequest: PermissionDTOs.PutRequest): Permission {
        return Permission(
            id = entity.id,
